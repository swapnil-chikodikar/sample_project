...
#             <br>
#
#             <form class="needs-validation" method="POST" action="/sample_app/deployment/"
#                   onsubmit="btn.disabled=true; btn.innerText='Deploying VMs. Please Wait'">
#                 {% csrf_token %}
#                 <div class="form-row">
...
#                 <!--<input type="submit" name="Submit" value="Deploy" onclick="this.disabled=true; this.value='Please Wait...';" />-->
#             </form>
#         </div>
#     </div>
# </div>
